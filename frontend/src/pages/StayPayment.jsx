            ...
            <section className="payment-details">
                ...
                <article className="reservation-details">
                    ...
                    <div className='dates flex space-between'>
                        ...
                        <button onClick={() => setModal(modalType === 'date' ? null : 'date')}>Edit</button>
                    </div>
                    ...
                    <div className='guests flex space-between'>
                        ...
                        <button onClick={() => setModal(modalType === 'guest' ? null : 'guest')}>Edit</button>
                    </div>

                    {/* {modalType === 'guests' && <GuestCountModal stay={stay} searchParams={searchParams} setSearchParams={setSearchParams} setModal={setModal} />}
                    {modalType === 'dates' && <DatesModal stay={stay} searchParams={searchParams} setSearchParams={setSearchParams} />} */}
                </article>
                        ...
                        <div className='payment-div flex column'>
                            ...
                            {isDownUpArrow === 'arrow-up' &&
                                <div className='choose-payment-method'>
                                    <ul>
                                        <li onClick={() => setPaymentMethod('credit')} className='flex'>
                                        ...
                                        <li onClick={() => setPaymentMethod('google')} className='flex'>
                        ...
                        {modalType === 'phone' && <>
                            ...
                            <div className='phone-modal flex column'>
                                <header className='flex center'>
                                    <button onClick={onModal} className='close-btn'></button>
                                ...
                                <main>
                                    ...
                                    <button className='add-btn' onClick={onModal}>Continue</button>
                                </main>
                            </div>
                        </>}
                    </article>
